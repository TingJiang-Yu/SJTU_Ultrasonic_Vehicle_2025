...
\subsection{main\_controller.cpp}
\lstinputlisting[language=C++,caption={主控制器代码实现 main\_controller.cpp}]{../Ultrasonic_Vehicle_2025/src/main_controller.cpp}
...
\subsection{motor\_controller.cpp}
\lstinputlisting[language=C++,caption={电机控制模块代码实现 motor\_controller.cpp}]{../Ultrasonic_Vehicle_2025/src/motor_controller.cpp}
...
\subsection{ultrasonic\_controller.cpp}
\lstinputlisting[language=C++,caption={超声波检测模块代码实现 ultrasonic\_controller.cpp}]{../Ultrasonic_Vehicle_2025/src/ultrasonic_controller.cpp}
...
\lstinputlisting[language=C++,caption={PID 控制器代码实现 pid\_controller.cpp}]{../Ultrasonic_Vehicle_2025/src/pid_controller.cpp}
